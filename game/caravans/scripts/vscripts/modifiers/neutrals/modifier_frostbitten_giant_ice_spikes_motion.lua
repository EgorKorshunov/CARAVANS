modifier_frostbitten_giant_ice_spikes_motion = class({})

--------------------------------------------------------------------------------

local MINIMUM_HEIGHT_ABOVE_LOWEST = 400
local MINIMUM_HEIGHT_ABOVE_HIGHEST = 200
local ACCELERATION_Z = 1500

--------------------------------------------------------------------------------

function modifier_frostbitten_giant_ice_spikes_motion:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_frostbitten_giant_ice_spikes_motion:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_frostbitten_giant_ice_spikes_motion:RemoveOnDeath()
	return false
end

--------------------------------------------------------------------------------

function modifier_frostbitten_giant_ice_spikes_motion:OnCreated( kv )
	if IsServer() then
...
function modifier_frostbitten_giant_ice_spikes_motion:OnDestroy()
	if IsServer() then
...
function modifier_frostbitten_giant_ice_spikes_motion:UpdateVerticalMotion( me, dt )
	if IsServer() then
...
function modifier_frostbitten_giant_ice_spikes_motion:OnVerticalMotionInterrupted()
	if IsServer() then
		self:Destroy()
	end
end
