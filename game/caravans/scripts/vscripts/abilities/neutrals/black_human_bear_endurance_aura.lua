...
LinkLuaModifier("modifier_black_human_bear_endurance_aura", "abilities/neutrals/black_human_bear_endurance_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_black_human_bear_endurance_aura_effect", "abilities/neutrals/black_human_bear_endurance_aura.lua", LUA_MODIFIER_MOTION_NONE)
